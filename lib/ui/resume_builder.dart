...
Future<Uint8List> generateResume({required PdfPageFormat format, required Resume resume}) async {

  // PdfPageFormat pageFormat = const PdfPageFormat(500, 700, marginAll: 10);
...
//
Future<pw.PageTheme> _myPageTheme(PdfPageFormat pdfPageFormat) async {
  final bgShape = await rootBundle.loadString('assets/resume.svg');

  pdfPageFormat = pdfPageFormat.applyMargin(
